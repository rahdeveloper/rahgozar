...
/**
 * Checks if the config type is carried by a core other than Xray (openvpn3 or
 * sing-box). Xray-specific settings — the routing presets, the panel's
 * tunnel_* keys — have no effect on these servers.
 *
